...
COLUMN_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "easting": ("easting", "east", "utm_e", "x_coord", "x_coordinate"),
    "northing": ("northing", "north", "utm_n", "y_coord", "y_coordinate"),
    "longitude": ("longitude", "lon", "long", "x_lon", "gps_lon"),
    "latitude": ("latitude", "lat", "y_lat", "gps_lat"),
