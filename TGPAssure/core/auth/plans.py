...
FEATURES: tuple[FeatureDef, ...] = (
    ...
    FeatureDef("seismic.qc", "seismic", "SEG-Y QC", "Run SEG-Y quality-control stages and reports.", 26000),
...
ACTION_FEATURE_OVERRIDES = {
    ...
    "segy_view_raw": "seismic.viewer",
    "segy_view_post_qc": "seismic.viewer",
    "segy_compare_pre_post": "seismic.viewer",
    "segy_run_qc": "seismic.qc",
    "segy_view_results": "seismic.qc",
    "segy_generate_pdf": "seismic.qc",
    "segy_generate_xlsx": "seismic.qc",
