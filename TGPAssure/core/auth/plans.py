...
FEATURES: tuple[FeatureDef, ...] = (
    ...
    FeatureDef("electrical.prosys", "electrical", "Prosys II Electrical/IP", "Prosys II-style resistivity, chargeability, IP decay, topography and Res2DInv/Res3DInv export.", 19000),
...
PROVIDER_FEATURE_MAP = {
    ...
    "electrical_prosys": "electrical.prosys",
...
ACTION_FEATURE_OVERRIDES = {
    ...
    "magnetic_open_folder": "magnetic.data",
    ...
    "electrical_open": "electrical.prosys",
    "electrical_open_data": "electrical.prosys",
    "electrical_prosys": "electrical.prosys",
    "electrical_export_csv": "electrical.prosys",
    "electrical_export_res2dinv": "electrical.prosys",
    "electrical_export_res3dinv": "electrical.prosys",
